      ...
      <main className="flex-1">
        ...
        <section className="py-20 md:py-32 border-b relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center max-w-5xl">
            {/* Iranian Flag - clean, no overlays */}
            <div className="flex justify-center mb-8">
              <img
                src={`data:image/png;base64,${FLAG_B64_PLACEHOLDER}`}
                alt="Iran Imperial Flag"
                className="w-64 md:w-80 rounded-xl border-2 border-primary/30 shadow-2xl shadow-primary/20"
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="w-20 h-1.5 flex rounded-full overflow-hidden">
                  <div className="flex-1 bg-[#239f40]" />
                  <div className="flex-1 bg-[#f5f0e8]" />
                  <div className="flex-1 bg-[#c00]" />
                </div>
